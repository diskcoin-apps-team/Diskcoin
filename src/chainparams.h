...
enum
{
    DEFAULT_MAINNET_PORT = 63333,
    DEFAULT_TESTNET_PORT = 63337,
    DEFAULT_NOLNET_PORT = 0,
    DEFAULT_REGTESTNET_PORT = 63339
};
...
public:
    ...
    //add for diskcoin -->
    uint64_t MaxBaseTarget() const { return nMaxBaseTarget; }
    //<--
protected:
    CChainParams() {}
