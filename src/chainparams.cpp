...
//add for diskcoin -->
uint64_t nMiningForkTime = 0;//1557921600;
#define SEEDSVR_DN "discseeder.com"
#define MAKE_SEEDSVR(prefix) prefix "." SEEDSVR_DN, prefix "." SEEDSVR_DN
//<--
...
static CBlock CreateGenesisBlock(uint32_t nTime,
    ...
    const CAmount &genesisReward)
{
    const char *pszTimestamp = "DISKCOIN start";
    const CScript genesisOutputScript = CScript()
                                        << ParseHex("04bdedc2a7d2b322592b276011767a4307f54991440cafdbed073ae7d1922700bf"
                                                    "99cb99392a4252ea9dbbb4369c56e0cf175bb92d8b1dc8b96a7ecb514df75255")
...
public:
    ...
    {
        strNetworkID = "main";
        consensus.nSubsidyHalvingInterval = 525000;//210000;
        // 00000000000000ce80a7e057163a4db1d5ad7b20fb6f598c9597b9665c8fb0d4 - April 1, 2012
        consensus.BIP16Height = 1;//173805;
        ...
        consensus.uahfHeight = 1;//478559;
        // Nov, 13 2017 hard fork
        consensus.daaHeight = 1e9;//504031;
        // May, 15 2018 hard fork
        consensus.may2018Height = 1;//1e9;//530359;
        // Nov, 15 2018 hard fork
        consensus.nov2018Height = 1;//1e9;//556766;
        consensus.sv2018Height = 1;//1e9;//556766;
        // Wed, 15 May 2019 12:00:00 UTC hard fork activation time
        consensus.may2019ActivationTime = 1;//2*1e9;//1557921600;
        ...
        //2019/7/21 22:6:40
        genesis = CreateGenesisBlock(1563718000, 1000000000, 0x1d0fffff, 1, 20 * COIN);
        ...
        //       uint256S("0x0000000496cb69ecf04d9ab771600d0b1e00f1599a191d3baa2a2c1a9f658e83"));
        //assert(
        //    genesis.hashMerkleRoot == uint256S("0x2696e97702d984af1369c54c44c4ad8a420916de49f420f0c8428648a51dd49b"));
        ...
        // }
		vSeeds.clear();
        vSeeds.push_back(CDNSSeedData(MAKE_SEEDSVR("seed1"), true));
        vSeeds.push_back(CDNSSeedData(MAKE_SEEDSVR("seed2"), true));
        vSeeds.push_back(CDNSSeedData(MAKE_SEEDSVR("seed3"), true));
        vSeeds.push_back(CDNSSeedData(MAKE_SEEDSVR("seed4"), true));
        vSeeds.push_back(CDNSSeedData(MAKE_SEEDSVR("seed5"), true));
        vSeeds.push_back(CDNSSeedData(MAKE_SEEDSVR("seed6"), true));
        vSeeds.push_back(CDNSSeedData(MAKE_SEEDSVR("seed7"), true));
        vSeeds.push_back(CDNSSeedData(MAKE_SEEDSVR("seed8"), true));
        vSeeds.push_back(CDNSSeedData(MAKE_SEEDSVR("seed9"), true));
        vSeeds.push_back(CDNSSeedData(MAKE_SEEDSVR("seed10"), true));
        vSeeds.push_back(CDNSSeedData(MAKE_SEEDSVR("seed11"), true));
        vSeeds.push_back(CDNSSeedData(MAKE_SEEDSVR("seed12"), true));
        vSeeds.push_back(CDNSSeedData(MAKE_SEEDSVR("seed13"), true));
        vSeeds.push_back(CDNSSeedData(MAKE_SEEDSVR("seed14"), true));
        vSeeds.push_back(CDNSSeedData(MAKE_SEEDSVR("seed15"), true));
...
public:
    CUnlParams()
    {
        ...
        genesis = CreateGenesisBlock(CScript() << 0, "Big blocks FTW (for the world)", outputScript, 1496544271,
            2301659837, 0x1d00ffff, 1, 20 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
...
public:
    CTestNetParams()
    {
        ...
        consensus.powLimit = uint256S("0000000fffffffffffffffffffffffffffffffffffffffffffffffffffffffff");
        consensus.nPowTargetTimespan = 14 * 24 * 60 * 60; // two weeks
        consensus.nPowTargetSpacing = 24; //2 * 60; //testnet 2 min
        consensus.fPowAllowMinDifficultyBlocks = false;
        consensus.fPowNoRetargeting = false;
        ...
        //2019-09-03 16:40:00
        genesis = CreateGenesisBlock(1567500000, 1000000000, 0x1d0fffff, 1, 20 * COIN);
        ...
        base58Prefixes[EXT_SECRET_KEY] =
            boost::assign::list_of(0x04)(0x88)(0xAD)(0xE4).convert_to_container<std::vector<unsigned char> >();
        cashaddrPrefix = "disc";
        nMaxBaseTarget = 18325193796ul;//4691249611844ul;//18325193796ul;//293203100740ul;
...
public:
    CRegTestParams()
    {
        ...
        consensus.powLimit = uint256S("0000000fffffffffffffffffffffffffffffffffffffffffffffffffffffffff");
        consensus.nPowTargetTimespan = 14 * 24 * 60 * 60; // two weeks
        consensus.nPowTargetSpacing = 2 * 60; //testnet 2 min
        consensus.fPowAllowMinDifficultyBlocks = false;
        consensus.fPowNoRetargeting = false;
        ...
        //2019/7/14 0:40:0
        genesis = CreateGenesisBlock(1563036000, 1000000000, 0x1d0fffff, 1, 20 * COIN);
        ...
        base58Prefixes[EXT_SECRET_KEY] =
            boost::assign::list_of(0x04)(0x88)(0xAD)(0xE4).convert_to_container<std::vector<unsigned char> >();
        cashaddrPrefix = "disc";
        nMaxBaseTarget = 4691249611844ul;//18325193796ul;//293203100740ul;
