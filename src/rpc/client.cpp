...
static const CRPCConvertParam vRPCConvertParams[] = {{"stop", 0}, {"setmocktime", 0}, {"getaddednodeinfo", 0},
    ...
    //add for diskcoin -->
    {"liststakein", 0}, {"liststakein", 1}, {"liststakein", 2},
    {"liststakeout", 0}, {"liststakeout", 1}, {"liststakeout", 2},
    {"listunstake", 0}, {"listunstake", 1}, {"listunstake", 2},
    {"staketo", 2},
    {"unstake", 1},
    {"listminedblock", 0}, {"listminedblock", 1}, {"listminedblock", 2},
    {"getaddrinfo", 0}, {"getaddrinfo", 1},
    {"ptest", 0},{"ptest", 1},
    //<--
